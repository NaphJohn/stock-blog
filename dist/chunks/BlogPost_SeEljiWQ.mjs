...
import 'piccolore';
import { $ as $$SiteHeader } from './SiteHeader_C5lBd-eY.mjs';
      ...
      (function () {
        ...
        if (btn) btn.addEventListener('click', function () {
          MingLiPay.showTipModal({
            title: '解锁付费章节',
            desc: '扫码打赏后，请输入作者私发的解锁码，即可解锁本专栏全部付费内容；作者本人免付费。',
