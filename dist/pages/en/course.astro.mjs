...
const $$Course = createComponent(($$result, $$props, $$slots) => {
  ...
  const course = {
    ...
    chapters: [
      ...
      { slug: "ch20-undervalued", title: "Undervalued Stock Screening Basics", desc: 'What "undervalued" means, PE/PB percentile & PEG, three screening conditions, value traps.', free: false, no: 20 },
      { slug: "ch21-long-short", title: "Long vs Short Basics", desc: "Long buys then sells for a rise; short sells then buys for a fall; a 4-step account opening guide; A-share short tools and the ¥500k barrier.", free: false, no: 21 }
    ]
  };
