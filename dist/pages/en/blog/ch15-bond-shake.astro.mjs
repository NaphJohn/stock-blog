...
const html = () => "<blockquote>\n<p>⚠️ Placeholder: this section will be replaced with the translated article. Outline only.</p>\n</blockquote>\n<h2 id=\"key-points\">Key points</h2>\n<ul>\n<li>(TBD) 债券基金在震荡市回撤买入为主，放宽收益容忍、至少保留 1/2 仓位。</li>\n<li>Buy on drawdowns vs historical mean; keep ≥1/2 position.</li>\n</ul>\n<h2 id=\"recap\">Recap</h2>\n<p>Full text to be added. Paid sections unlock after a tip (min ¥1).</p>";
				...
				const frontmatter = {"title":"Bond funds in a ranging market","description":"债券基金震荡市的买点与卖出纪律（英文翻译待补充）。","layout":"../../../layouts/BlogPost.astro","series":"Fund Strategy","free":false,"lang":"en","altLang":"中文","altHref":"/","pubDate":"2026-08-07T00:00:00.000Z"};
