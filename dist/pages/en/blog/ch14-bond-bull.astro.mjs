...
const html = () => "<h1 id=\"bond-funds-in-a-bull-market-invest-in-one-shot\">Bond funds in a bull market: invest in one shot</h1>\n<blockquote>\n<p>⚠️ Placeholder: this section will be replaced with the translated article. Outline only.</p>\n</blockquote>\n<h2 id=\"key-points\">Key points</h2>\n<ul>\n<li>(TBD) 债券基金在牛市一次性买入：历史月均收益为买点，年化达标分三批卖出。</li>\n<li>Use a system instead of predictions: buy below historical average, scale out in thirds.</li>\n</ul>\n<h2 id=\"recap\">Recap</h2>\n<p>Full text to be added. Paid sections unlock after a tip (min ¥1).</p>";

				const frontmatter = {"title":"Bond funds in a bull market: invest in one shot","description":"债券基金牛市的买点与卖出纪律（英文翻译待补充）。","layout":"../../../layouts/BlogPost.astro","series":"Xiaobei Fund Strategy","free":false,"lang":"en","altLang":"中文","altHref":"/","pubDate":"2026-08-07T00:00:00.000Z"};
				...
				function getHeadings() {
					return [{"depth":1,"slug":"bond-funds-in-a-bull-market-invest-in-one-shot","text":"Bond funds in a bull market: invest in one shot"},{"depth":2,"slug":"key-points","text":"Key points"},{"depth":2,"slug":"recap","text":"Recap"}];
				}
