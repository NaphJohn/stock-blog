...
const html = () => "<h1 id=\"sector-fund-rotation-ride-the-up-cycle\">Sector fund rotation: ride the up-cycle</h1>\n<blockquote>\n<p>⚠️ Placeholder: this section will be replaced with the translated article. Outline only.</p>\n</blockquote>\n<h2 id=\"key-points\">Key points</h2>\n<ul>\n<li>(TBD) 行业 ETF 的买点、卖点与止盈。</li>\n<li>Use a system instead of predictions: stagger buys, DCA, stop-loss.</li>\n<li>Set executable buy/sell rules from valuation and your cash flow.</li>\n</ul>\n<h2 id=\"recap\">Recap</h2>\n<p>Full text to be added. Paid sections unlock after a tip (min ¥1).</p>";

				const frontmatter = {"title":"Sector fund rotation: ride the up-cycle","description":"行业 ETF 的买点、卖点与止盈。","layout":"../../../layouts/BlogPost.astro","series":"Xiaobei Fund Strategy","free":false,"lang":"en","altLang":"中文","altHref":"/","pubDate":"2026-08-06T00:00:00.000Z"};
				const file = "/Users/hangkai/WorkBuddy/Claw/stock-blog/src/pages/en/blog/ch5-sector.md";
				const url = "/stock-blog/en/blog/ch5-sector";
				function rawContent() {
					return "   \n                                                \n                                \n                                       \n                             \n           \n        \n           \n          \n                   \n   \n\n# Sector fund rotation: ride the up-cycle\n\n> ⚠️ Placeholder: this section will be replaced with the translated article. Outline only.\n\n## Key points\n\n- (TBD) 行业 ETF 的买点、卖点与止盈。\n- Use a system instead of predictions: stagger buys, DCA, stop-loss.\n- Set executable buy/sell rules from valuation and your cash flow.\n\n## Recap\n\nFull text to be added. Paid sections unlock after a tip (min ¥1).\n";
				}
				async function compiledContent() {
					return await html();
				}
				function getHeadings() {
					return [{"depth":1,"slug":"sector-fund-rotation-ride-the-up-cycle","text":"Sector fund rotation: ride the up-cycle"},{"depth":2,"slug":"key-points","text":"Key points"},{"depth":2,"slug":"recap","text":"Recap"}];
				}
