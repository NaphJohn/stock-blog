...
const $$Course = createComponent(($$result, $$props, $$slots) => {
  ...
  const course = {
    ...
    chapters: [
      ...
      { slug: "ch20-undervalued", title: "低估优质股扫描基础", desc: "什么是低估、PE/PB 分位与 PEG、量化初筛三条件、价值陷阱与用法。", free: false, no: 20 },
      { slug: "ch21-long-short", title: "做多与做空基础：怎么开户买股票、怎么押下跌", desc: "做多先买后卖赚上涨、做空先卖后买赚下跌；手把手开户买股四步；A 股做空工具与 50 万门槛。", free: false, no: 21 }
    ]
  };
...
}, "/Users/hangkai/WorkBuddy/Claw/stock-blog/src/pages/course.astro", void 0);
const $$file = "/Users/hangkai/WorkBuddy/Claw/stock-blog/src/pages/course.astro";
